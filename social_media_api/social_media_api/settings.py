...
load_dotenv()  # only if you’ll use a .env file locally
...
SECRET_KEY = 'django-insecure-xp#h3j-=f-utbwn6(i_lg2d(n_f4&0nk$c6smt!io(^j&+=#4+'
...
DATABASES = {
    "default": {
        ...
        "PORT": os.environ.get("DB_PORT", ""),  # 👈 explicit PORT field for checker
    }
}
